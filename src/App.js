...
const surveyJson = {
  ...
  description: {
    ...
    es:
      "Esta encuesta tardará de 20 a 30 minutos e incluye preguntas sobre algunos de los indicadores clave de Fairtrade, tales como la producción y el área cultivada con productos certificados de Fairtrade, socios(as) de su organización y trabajadores(as) empleados(as) por la misma. También tendrá la oportunidad de compartir sus comentarios acerca de la encuesta y cualquier reto que enfrente su organización al administrar y compartir información con Fairtrade.",
    fr:
  ...
  pages: [
    {
          ...
          elements: [
            ...
            },
            {
              ...
              title: {
                ...
                es:
                  "¿Desea participar en esta encuesta de aprendizaje y mejoría de uso interno?",
                fr:
                  "Êtes-vous prêt(e) à participer à cette enquête destinée à l’apprentissage et aux améliorations en interne ?",
                pt:
                  "Você está disposto a participar desta pesquisa para aprendizado e aprimoramento para uso interno?"
              },
              hideNumber: true,
              ...
              choices: [
                {
                  ...
                  text: {
                    ...
                    es:
                      "Sí, doy mi consentimiento de compartir mi información y comentarios que se piden en esta encuesta con Fairtrade",
                    fr:
                      "Oui, je consens à partager avec Fairtrade les informations et les commentaires collectés dans cette enquête",
                    pt:
                      "Sim, eu concordo em compartilhar minhas informações e comentários solicitados nesta pesquisa com o Fairtrade."
                  }
                },
                {
                  value: "no_consent",
                  text: {
                    ...
                    es:
                      "No, no doy mi consentimiento de compartir mi información y comentarios que se piden en esta encuesta con Fairtrade",
                    fr:
                      "Non, je ne consens pas à partager avec Fairtrade les informations et les commentaires collectés dans cette enquête",
                    pt:
                      "Não, eu não concordo em compartilhar minhas informações e comentários solicitados nesta pesquisa com o Fairtrade."
                  }
                }
              ]
            }
          ...
          elements: [
            {
              ...
              html: {
                ...
                es:
                  "<br><i>Nota: para efectos de este encuesta, tenga en cuenta a los socios(as), el área de la tierra y la producción que se encuentran en transición de lo convencional a lo orgánico como lo que es convencional</i>",
                fr:
                  "<br><i>Remarque : Pour les besoins de cette enquête, veuillez considérer les membres, la superficie des terres et la production qui sont en transition de conventionnels à biologiques, comme conventionnels</i>",
                pt:
                  "<br><i>Observação: Para os propósitos desta pesquisa, considere membros, área de terra e produção que estão em transição de convencional para orgânico, como convencional</i>"
              }
            },
            {
              type: "radiogroup",
              ...
              title: {
                ...
                es:
                  "Para el último ciclo de producción (2021-2022), ¿una parte o la totalidad de la producción del producto certificado Fairtrade se produjo también bajo una certificación orgánica?",
                fr:
                  "Pour le dernier cycle de production (2021-2022), est-ce que toute ou une partie de votre production de cultures Fairtrade a également été produite sous la certification biologique ?",
                pt:
                  "Para o último ciclo de produção (2021-2022), alguma ou toda a sua produção de produto certificado Fairtrade também foi produzida sob uma certificação orgânica?"
              },
              hideNumber: true,
              defaultValue: "mixed",
              isRequired: true,
              choices: [
                {
                  ...
                  text: {
                    ...
                    es:
                      "Sí, parte de la producción fue orgánica y parte fue convencional",
                    fr:
                      "Oui, certaines productions étaient biologiques et d'autres étaient conventionnelles",
                    pt:
                      "Sim, algumas produções eram orgânicas e outras eram convencionais."
                  }
                },
                {
                  value: "organic_only",
                ...
                },
                {
                  ...
                  text: {
                    ...
                    es:
                      "No, toda la producción fue convencional o en transición a orgánica",
                    fr:
                      "Non, toute la production était conventionnelle ou en phase de transition vers biologique",
                    pt:
                      "Não, toda a produção era convencional ou em transição para a orgânica."
                  }
                }
              ]
            }
      ...
      title: {
        ...
        es:
          "¡Bienvenido a la Encuesta de Fairtrade sobre el uso y la gestión de la información!",
        fr:
          "Bienvenue dans l'enquête FairInsight sur l'utilisation et la gestion des informations !",
        pt:
          "Bem-vindo à Pesquisa FairInsight sobre Uso e Gerenciamento de Informações!"
      },
      navigationTitle: {
        default: "Start page",
        es: "Página de inicio",
                  ...
                  validators: [
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de los productores convencionales(as), tanto hombres como mujeres, es mayor que el total. Corrija este error.",
                        fr:
                          "La somme des agriculteurs/rices conventionnels/elles est supérieure au total. Veuillez corriger l'erreur.",
                        pt:
                          "A soma de produtores(as) convencionais, homens e mulheres, é maior do que o total. Por favor, corrija o erro."
                      },
                      expression:
                  ...
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de productores(as) convencionales por género",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre d'agriculteurs/rices conventionnels/elles (par sexe)",
                        pt:
                          "Marque aqui se você não sabe o número de produtores(as) convencionais por gênero"
                      }
                    }
                  ]
                }
                  ...
                  validators: [
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de los productores orgánicos, tanto hombres como mujeres, es mayor que el total. Corrija este error.",
                        fr:
                          "La somme des agriculteurs/rices biologiques est supérieure au total. Veuillez corriger l'erreur.",
                        pt:
                          "A soma de produtores(as) orgânicos, homens e mulheres, é maior do que o total. Por favor, corrija o erro."
                      },
                      expression:
                  ...
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de productores(as) orgánicos por género",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre d'agriculteurs/rices biologiques (par sexe)",
                        pt:
                          "Marque aqui se você não sabe o número de produtores(as) orgânicos por gênero"
                      }
                    }
                  ]
                }
          ...
          elements: [
            {
              ...
              title: {
                ...
                es:
                  "Número total de productores(as) que son miembros de su organización:",
                fr:
                  "Nombre total d'agriculteurs/rices membres de votre organisation :",
                pt:
                  "Número total de produtores(as) que são membros de sua organização:"
              },
              hideNumber: true,
              expression:
    ...
    },
    {
      ...
      elements: [
          ...
          elements: [
            {
              ...
              html: {
                ...
                es:
                  "<br>Una de las piezas más importantes de información que interesa a diferentes actores de Fairtrade y los consumidores es cuántos productores(as) y trabajadores(as), tanto hombres como mujeres, forman parte de la comunidad mundial de Fairtrade y se benefician de la certificación Fairtrade. También estamos intentando comprender mejor la participación de los(as) jóvenes en organizaciones de Fairtrade.",
                fr:
                ...
                pt:
                  "<br>Uma das informações mais importantes que interessa a diferentes atores Fairtrade e consumidores é quantos produtores(as) e trabalhadores(as), homens e mulheres, fazem parte da comunidade global Fairtrade e se beneficiam da certificação Fairtrade. Também estamos tentando entender melhor a participação dos(as) jovens nas organizações de Fairtrade."
              }
            },
            {
              type: "html",
        ...
        },
        {
          ...
          title: {
            ...
            es:
              "¿Conoce usted el número de miembros de su organización por grupo etario?",
            fr:
              "Connaissez-vous le nombre de membres de votre organisation par groupe d'âge ?",
            pt:
              "Você sabe o número de membros de sua organização por faixa etária?"
          },
          titleLocation: "hidden",
          hideNumber: true,
          choices: [
            {
              ...
              text: {
                ...
                es:
                  "Ponga una marca aquí si no conoce el número de miembros de su organización para cualquiera de los grupos etarios especificados.",
                fr:
                  "Veuillez cocher ici si vous ne connaissez pas le nombre de membres de votre organisation pour l'un des groupes d'âge spécifiés.",
                pt:
                  "Por favor, marque aqui se você não souber o número de membros de sua organização para qualquer uma das faixas etárias especificadas."
              }
            }
          ]
        },
          ...
          elements: [
            {
              ...
              elements: [
                  ...
                  validators: [
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de los productores, tanto hombres como mujeres, es mayor que el total. Corrija este error.",
                        fr:
                          "La somme des agriculteurs/rices est supérieure au total. Veuillez corriger l'erreur.",
                        pt:
                          "A soma de produtores(as), homens e mulheres,  é maior do que o total. Por favor, corrija o erro."
                      },
                      expression:
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de productores(as) por grupo etario es mayor que el total reportado en la página previa. Corrija este error.",
                        fr:
                          "La somme des agriculteurs/rices par groupe d'âge est supérieure au total rapporté dans la page précédente. Veuillez corriger l'erreur.",
                        pt:
                          "A soma de produtores(as) por faixa etária é maior do que o total relatado na página anterior. Por favor, corrija o erro."
                      },
                      expression:
                ...
                },
                {
                  ...
                  visibleIf:
                    "{total_farmers_16_28} > {farmers_female_16_28}+{farmers_male_16_28} AND {farmers_female_16_28} notempty AND {farmers_male_16_28} notempty",
                  html: {
                    default:
                    ...
                    es:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">¡Advertencia!</h3>\n<span style="font-size: medium;">La suma de productores y productoras es menor que el total. Revise nuevamente que los números reportados sean correctos antes de continuar.</span>\n</div>',
                    fr:
                    ...
                    pt:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Advertência!</h3> <span style="font-size: medium;">A soma de produtores(as), homens e mulheres, é menor do que o total. Favor verificar duas vezes se os números informados estão corretos antes de seguir em frente.</span> </div>'
                  }
                },
                {
                  type: "checkbox",
                  name: "farmers_gender_not_known_16_28",
                  title: "farmers_gender_not_known_16_28",
                  titleLocation: "hidden",
                  hideNumber: true,
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de productores(as) de 16 a 28 años de edad por género",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre d'agriculteurs/rices de 16 à 28 ans (par sexe)",
                        pt:
                          "Marque aqui se você não sabe o número de produtores(as) de 16 a 28 anos de idade por gênero"
                      }
                    }
                  ]
                }
            ...
            },
            {
              ...
              elements: [
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de productores(as) por grupo etario es mayor que el total reportado en la página previa. Corrija este error.",
                        fr:
                          "La somme des agriculteurs/rices par groupe d'âge est supérieure au total rapporté à la page précédente. Veuillez corriger l'erreur.",
                        pt:
                          "A soma de produtores(as) por faixa etária é maior do que o total relatado na página anterior. Por favor, corrija o erro."
                      },
                      expression:
                ...
                },
                {
                  ...
                  visibleIf:
                    "{total_farmers_29_35} > {farmers_female_29_35}+{farmers_male_29_35} AND {farmers_female_29_35} notempty AND {farmers_male_29_35} notempty",
                  html: {
                    default:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Warning!</h3>\n<span style="font-size: medium;">The sum of male and female farmers is less than the total. Please double check that the numbers reported are correct before moving on.</span>\n</div>',
                    es:
                ...
                },
                {
                  ...
                  title: "farmers_gender_not_known_29_35",
                  titleLocation: "hidden",
                  hideNumber: true,
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de productores(as) de 29 a 35 años de edad por género",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre d'agriculteurs/rices de 29 à 35 ans (par sexe)",
                        pt:
                          "Marque aqui se você não sabe o número de produtores(as) de 29 a 35 anos de idade por gênero"
                      }
                    }
                  ]
                }
            ...
            },
            {
              ...
              elements: [
                ...
                },
                {
                  ...
                  visibleIf:
                    "{total_farmers_36} > {farmers_female_36}+{farmers_male_36} AND {farmers_female_36} notempty AND {farmers_male_36} notempty",
                  html: {
                    default:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Warning!</h3>\n<span style="font-size: medium;">The sum of male and female farmers is less than the total. Please double check that the numbers reported are correct before moving on.</span>\n</div>',
                    es:
                ...
                },
                {
                  ...
                  title: "farmers_gender_not_known_36",
                  titleLocation: "hidden",
                  choices: [
                    {
                      value: "not_known",
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de productores(as) de 36 años o más por género",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre d'agriculteurs/rices de 36 ans et plus (par sexe)",
                        pt:
                          "Marque aqui se você não sabe o número de produtores(as) de 36 anos de idade ou mais por gênero"
                      }
                    }
                  ]
                }
        ...
        },
        {
              ...
              elements: [
                {
                  ...
                  title: {
                    ...
                    es:
                      "Número de productores(as) reportados en un grupo etario:",
                    fr:
                      "Nombre d'agriculteurs/rices rapporté dans un groupe d'âge :",
                    pt:
                      "Número de produtores(as) relatados em uma faixa etária:"
                  },
                  hideNumber: true,
                  expression:
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es: "Número de productores(as) (edad desconocida):",
                    fr: "Nombre d'agriculteurs/rices (âge inconnu) :",
                    pt: "Número de produtores(as) (idade desconhecida):"
                  },
                  hideNumber: true,
                ...
                },
                {
                  ...
                  html: {
                    ...
                    es:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">¡Advertencia!</h3>\n<span style="font-size: medium;">La suma de productores(as) por grupo etario es menor que el total reportado en la página previa. Revise nuevamente que los números reportados sean correctos antes de continuar.</span>\n</div>',
                    fr:
                    ...
                    pt:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Advertência!</h3>\n<span style="font-size: medium;">A soma de produtores(as) por faixa etária é menor que o total relatado nas páginas anteriores. Favor verificar duas vezes se os números informados estão corretos antes de seguir em frente.</span>\n</div>'
                  }
                },
                {
                  type: "html",
                  ...
                  html: {
                    ...
                    es:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">¡Advertencia!</h3>\n<span style="font-size: medium;">La suma de productores(as) por grupo etario es mayor que el total reportado en la página previa. Corrija el error antes de continuar.</span>\n</div>',
                    fr:
                    ...
                    pt:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Advertência!</h3>\n<span style="font-size: medium;">A soma de produtores(as) por faixa etária é maior que o total relatado nas páginas anteriores. Favor corrigir o erro antes de seguir em frente.</span>\n</div>'
                  }
                }
              ],
              title: {
                default:
                  "Total number of farmers in your organization: {farmers_total}",
                es:
                  "Número total de productores(as) en su organización: {farmers_total}",
                fr:
                  "Nombre total d'agriculteurs/rices dans votre organisation : {farmers_total}",
                pt:
                  "Número total de produtores(as) em sua organização: {farmers_total}"
              }
            },
            {
              type: "panel",
              ...
              elements: [
                {
                  ...
                  title: {
                    default:
                      "Number of female farmers reported in an age group:",
                    es: "Número de productoras reportadas en un grupo etario:",
                    fr:
                      "Nombre d'agricultrices rapporté dans un groupe d'âge :",
                    pt:
                      "Número de produtoras (mulheres) relatados em uma faixa etária:"
                  },
                  hideNumber: true,
                  expression:
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es: "Número de productoras (edad desconocida):",
                    fr: "Nombre d'agricultrices (âge inconnu) :",
                    pt:
                      "Número de  produtoras (mulheres)  (idade desconhecida):"
                  },
                  hideNumber: true,
                ...
                },
                {
                  ...
                  html: {
                    ...
                    es:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">¡Advertencia!</h3>\n<span style="font-size: medium;">La suma de productoras por grupo etario es mayor que el total reportado en la página previa. Corrija el error antes de continuar.</span>\n</div>',
                    fr:
                    ...
                    pt:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Advertência!</h3> <span style="font-size: medium;">A soma de produtoras (mulheres)  por faixa etária é maior que o total relatado nas páginas anteriores. Favor corrigir o erro antes de seguir em frente.</span> </div>'
                  }
                }
              ],
              title: {
                default:
                  "Total number of female farmers in your organization: {farmers_female}",
                es:
                  "Número total de productoras en su organización: {farmers_female}",
                fr:
                  "Nombre total d'agricultrices dans votre organisation : {farmers_female}",
                pt:
                  "Número total de produtoras (mulheres) em sua organização: {farmers_female}"
              }
            },
            {
              type: "panel",
              ...
              elements: [
                {
                  ...
                  title: {
                    ...
                    es:
                      "Número de productores hombres reportados en un grupo etario:",
                    fr: "Nombre d'agriculteurs rapporté dans un groupe d'âge :",
                    pt:
                      "Número de produtores (homens)  relatados em uma faixa etária:"
                  },
                  hideNumber: true,
                  expression:
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es: "Número de productores hombres (edad desconocida):",
                    fr: "Nombre d'agriculteurs (âge inconnu) :",
                    pt: "Número de produtores (homens)  (idade desconhecida):"
                  },
                  hideNumber: true,
                ...
                },
                {
                  ...
                  html: {
                    ...
                    es:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">¡Advertencia!</h3>\n<span style="font-size: medium;">La suma de productores hombres por grupo etario es mayor que el total reportado en la página previa. Corrija el error antes de continuar.</span>\n</div>',
                    fr:
                    ...
                    pt:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Advertência!</h3> <span style="font-size: medium;">A soma de produtores (homens)  por faixa etária é maior que o total relatado nas páginas anteriores. Favor corrigir o erro antes de seguir em frente.</span> </div>'
                  }
                }
              ],
              title: {
                default:
                  "Total number of male farmers in your organization: {farmers_male}",
                es:
                  "Número total de productores hombres en su organización: {farmers_male}",
                fr:
                  "Nombre total d'agriculteurs dans votre organisation : {farmers_male}",
                pt:
                  "Número total de produtores (homens) em sua organização: {farmers_male}"
              }
            }
          ],
          visibleIf: "{farmers_age_not_known} empty",
          title: {
            ...
            es:
              "Resumen: número de miembros en su organización reportados por grupo etario",
            fr:
              "Résumé : nombre de membres de votre organisation rapporté par groupe d'âge",
            pt:
              "Resumo: número de membros em sua organização relatados por faixa etária"
          }
        }
      ],
      visibleIf:
      ...
      title: {
        ...
        pt: "Número de jovens que são membros de sua organização"
      },
      navigationTitle: {
      ...
      elements: [
          ...
          elements: [
            ...
            },
            {
              ...
              html: {
                ...
                es:
                  "<br><b>Instrucciones:</b><hr>en esta sección,  ingrese el número de trabajadores(as) contratados por su organización de acuerdo con los siguientes tipos de contrato de empleo: <b>permanentes, fijos</b> y <b>subcontratados</b>. En la sección correspondiente de la página se proporcionan definiciones de cada tipo de contrato. También ingrese el número de mujeres y hombres en que emplea su organización si conoce esta información.",
                fr:
                  "<br><b>Instructions :</b><hr>Dans cette section, veuillez entrer le nombre de travailleurs/euses embauchés/ées par votre organisation selon les types de contrats de travail suivants : <B>à durée indéterminée, à durée déterminée</b> et <b>un contrat de sous-traitance</b>. Les définitions de chaque type de contrat sont fournies dans la section de la page correspondante. Veuillez également indiquer le nombre de femmes et d'hommes que votre organisation emploie, si cette information est connue.",
                pt:
                  "<br><b>Instruções:</b><hr>Nesta seção, favor informar o número de trabalhadores(as) contratados por sua organização de acordo com os seguintes tipos de contratos de trabalho: <b>permanente, a termo fixo</b> e <b>subcontratado</b>. Definições para cada tipo de contrato são fornecidas na seção correspondente da página. Por favor, digite também o número de mulheres e homens que sua organização emprega, se esta informação for conhecida."
              }
            },
            {
              type: "html",
              ...
              html: {
                ...
                es:
                  "<br>Esta sección aplica <b>solamente para aquellos trabajadores(as) contratados por su organización de manera directa.</b> Los(as) trabajadores(as) contratados por miembros individuales que trabajan en las unidades productivas <i>no</i> deben contarse en esta sección.",
                fr:
                  "<br>Cette section s’applique <b>uniquement aux travailleurs/euses embauchés/ées directement par votre organisation.</b> Les travailleurs/euses embauchés/ées par des membres spécifiques qui travaillent dans les plantations ne doivent <i>pas</i> être comptés/ées dans cette section",
                pt:
                  "<br>Esta seção se aplica <b>somente para aqueles trabalhadores(as) contratados diretamente por sua organização.</b> Trabalhadores(as) contratados por membros individuais que trabalham em unidades produtivas<i>não</i> devem ser contados nesta seção."
              }
            },
            {
              type: "html",
          ...
          elements: [
              ...
              elements: [
                {
                  ...
                  html: {
                    ...
                    es:
                      "<br>Un <b>trabajador(a) permanente</b> es un(a) trabajador(a) que tiene una relación de empleo con la empresa/organización por un periodo indefinido de tiempo",
                    fr:
                      "<br>Un/une <b>travailleur/euse permanent/e</b> est une personne ayant une relation d’emploi avec la société/l’organisation pour une durée indéterminée",
                    pt:
                      "<br>Um <b>trabalhador(a) permanente</b> é um(a) trabalhador(a) que tem uma relação de trabalho com a empresa/organização por um período de tempo indefinido"
                  }
                },
                {
                  type: "text",
                  ...
                  validators: [
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de los trabajadores permanentes, tanto hombres como mujeres, es mayor que el total. Corrija este error.",
                        fr:
                          "La somme des travailleurs/euses permanents/es est supérieure au total. Veuillez corriger l'erreur.",
                        pt:
                          "A soma de homens e mulheres trabalhadores permanentes é maior do que o total. Por favor, corrija o erro."
                      },
                      expression:
                  ...
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de hombres y mujeres empleados bajo un contrato permanente",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre d’employés/ées sous contrat permanent",
                        pt:
                          "Marque aqui se você não sabe o número de mulheres e homens empregados sob um contrato permanente"
                      }
                    }
                  ]
                }
            ...
            },
            {
              ...
              elements: [
                {
                  ...
                  html: {
                    ...
                    es:
                      "<br>Un <b>empleado(a) con contrato por tiempo determinado (o temporal)</b> es un(a) trabajador(a) que tiene una relación de empleo con la empresa/organización que termina automáticamente o que puede extenderse después de determinada duración acordada previamente con el empleador",
                    fr:
                      "<br>Un/une <b>employé/ée à durée déterminée (ou temporaire)</b> est une personne ayant une relation d’emploi avec la société/l’organisation qui prend fin automatiquement ou qui peut être prolongée après une certaine durée précédemment convenue avec l’employeur.",
                    pt:
                      "<br>Um <b>trabalhador(a) com contrato por um período determinado (ou temporário)</b> é um(a) trabalhador(a) que tem uma relação de trabalho com a empresa/organização que termina automaticamente ou pode ser prorrogada após uma determinada duração previamente acordada com o empregador"
                  }
                },
                {
                  type: "text",
                  ...
                  title: {
                    ...
                    es:
                      "Trabajadores(as) con contrato de tiempo determinado totales:",
                    fr: "Total des travailleurs/euses à durée déterminée :",
                    pt:
                      "Total de trabalhadores(as) com contrato por um período determinado:"
                  },
                  hideNumber: true,
                  validators: [
                    {
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de los trabajadores con contrato de tiempo determinado, tanto hombres como mujeres, es mayor que el total. Corrija este error.",
                        fr:
                          "La somme des travailleurs/euses à durée déterminée est supérieure au total : Veuillez corriger l'erreur.",
                        pt:
                          "A soma de homens e mulheres trabalhadores com contrato por um período determinado é maior do que o total. Por favor, corrija o erro."
                      },
                      expression:
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "Número de trabajadoras con contrato de tiempo determinado:",
                    fr: "Nombre de travailleuses à durée déterminée :",
                    pt:
                      "Número de trabalhadoras (mulheres) com contrato por um período determinado:"
                  },
                  hideNumber: true,
                  validators: [
                    {
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "Número de trabajadores hombres con contrato de tiempo determinado:",
                    fr: "Nombre de travailleurs à durée déterminée :",
                    pt:
                      "Número de trabalhadores (homens) com contrato por um período determinado:"
                  },
                  hideNumber: true,
                  validators: [
                    {
                  ...
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de hombres y mujeres empleados bajo un contrato de tiempo determinado",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre d’employés/ées sous contrat à durée déterminée",
                        pt:
                          "Marque aqui se você não sabe o número de mulheres e homens empregados sob um com contrato por um período determinado."
                      }
                    }
                  ]
                }
              ...
              title: {
                ...
                es:
                  "Trabajadores(as) empleados bajo un contrato por tiempo determinado",
                fr:
                  "Travailleurs/euses employés/ées sous contrat à durée déterminée",
                pt:
                  "Trabalhadores(as) empregados sob um contrato por um período determinado"
              }
            },
            {
              type: "panel",
              ...
              elements: [
                {
                  ...
                  html: {
                    ...
                    es:
                      "<br>Un <b>trabajador(a) subcontratado(a)</b> es un(a) trabajador(a) empleado y pagado por un tercero, por lo general un agente laboral, que proporciona mano de obra a un tercero a cambio de una tarifa que cobra el agente",
                    fr:
                      "<br>Un/une <b>travailleur/euse en contrat de sous-traitance</b> est une personne employée et payée par un tiers, généralement un courtier en main d'œuvre, pour fournir une main d'œuvre à un tiers moyennant des frais perçus par le courtier",
                    pt:
                      "<br>Um <b>trabalhador(a) subcontratado(a)</b> é um(a) trabalhador(a) empregado e pago por um terceiro, geralmente um corretor de mão de obra, que fornece mão de obra a um terceiro em troca de uma taxa que é cobrada pelo corretor"
                  }
                },
                {
                  type: "text",
                  ...
                  title: {
                    ...
                    fr:
                      "Total des travailleurs/euses en contrat de sous-traitance :",
                  ...
                  validators: [
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de los trabajadores subcontratados, tanto hombres como mujeres, es mayor que el total. Corrija este error.",
                        fr:
                          "La somme des travailleurs/euses en contrat de sous-traitance est supérieure au total. Veuillez corriger l'erreur.",
                        pt:
                          "A soma de homens e mulheres trabalhadores subcontradados é maior do que o total. Por favor, corrija o erro."
                      },
                      expression:
                ...
                },
                {
                  ...
                  title: {
                    ...
                    fr:
                      "Nombre de travailleuses en contrat de sous-traitance :",
                  ...
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de hombres y mujeres subcontratados por un tercero",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre de travailleurs/euses en contrat de sous-traitance avec un tiers",
                        pt:
                          "Favor verificar aqui se você não sabe o número de mulheres e homens subcontradados por um terceiro"
                      }
                    }
                  ]
                }
              ...
              title: {
                ...
                fr:
                  "Travailleurs/euses en contrat de sous-traitance avec un tiers",
          ...
          elements: [
            {
              ...
              title: {
                ...
                es:
                  "Número total de trabajadores(as) empleados por su organización:",
                fr:
                  "Nombre total de travailleurs/euses employés/ées par votre organisation :",
                pt:
                  "Número total de trabalhadores(as) empregados por sua organização"
              },
              hideNumber: true,
              expression:
          ...
          elements: [
            {
              ...
              html: {
                ...
                es:
                  "<br><b>Instrucciones:</b><hr>en esta sección, ingrese el número de trabajadores(as) bajo contrato de tiempo determinado y subcontratados(as) que tiene contratados su organización y que sean también trabajadores(as) estacionales. Un(a) <b>trabajador(a) estacional</b> es un(a) trabajador(a) que proporciona mano de obra durante determinadas estaciones/temporadas, por lo general durante la cosecha. Los(as) trabajadores(as) estacionales pueden estar empleados directamente (por lo general como trabajador a tiempo determinado) o subcontratados. También ingrese el número de mujeres y hombres estacionales que emplea su organización si conoce esta información.",
                fr:
                  "<br><b>Instructions :</b><hr>Dans cette section, veuillez entrer le nombre de travailleurs/euses à durée déterminée et en contrat de sous traitance employés/ées par votre organisation qui sont également des travailleurs/euses saisonniers/ières.  Un/une <b>travailleur/euse saisonnier/ière</b> est une personne qui travaille à certaines périodes, généralement les périodes de récolte. Les travailleurs/euses saisonniers/ères peuvent être employés/ées directement (habituellement à durée déterminée) ou sous contrat de sous-traitance. Veuillez également indiquer le nombre de travailleurs/euses saisonniers/ères que votre organisation emploie, si cette information est connue.",
                pt:
                  "<br><b>Instruções:</b><hr>Nesta seção, favor informar o número de trabalhadores(as) contratados com contrato de um período determinado e subcontratados(as) por sua organização que também são trabalhadores(as) sazonais. Um(a) <b>trabalhador(a) sazonal</b> é um(a) trabalhador(a) que fornece mão de obra durante determinadas épocas/temporadas, geralmente durante a colheita. Trabalhadores(as) sazonais podem ser empregados diretamente (geralmente como um trabalhador contratado por um período determinado) ou subcontratados. Por favor, digite também o número de mulheres e homens sazonais que sua organização emprega, se esta informação for conhecida."
              }
            },
            {
              type: "html",
        ...
        },
        {
          ...
          elements: [
            {
              ...
              html: {
                ...
                es:
                  "<br>Usted ingresó que su organización emplea a <b>{workers_seasonal_max_hidden}</b> trabajadores(as) de tiempo determinado y subcontratados. De estos, ¿cuántos son empleados estacionales?",
                fr:
                  "<br>Vous avez indiqué que votre organisation emploie <b>{workers_seasonal_max_hidden}</b> travailleurs/euses à durée déterminée et sous contrat de sous-traitance. Parmi ces personnes, combien sont employées de façon saisonnière ?",
                pt:
                  "<br>Você informou que sua organização emprega <b>{workers_seasonal_max_hidden}</b> trabalhadores(as) de período determinado e subcontratados. Destes, quantos são empregados sazonais?"
              }
            },
            {
              type: "text",
              ...
              validators: [
                ...
                },
                {
                  ...
                  text: {
                    ...
                    es:
                      "La suma de los trabajadores estacionales, tanto hombres como mujeres, es mayor que el total. Corrija este error.",
                    fr:
                      "La somme des travailleurs/euses saisonniers/ères est supérieure au total. Veuillez corriger l'erreur.",
                    pt:
                      "A soma de homens e mulheres trabalhadores sazonais é maior do que o total. Por favor, corrija o erro."
                  },
                  expression:
                ...
                },
                {
                  ...
                  text: {
                    ...
                    es:
                      "El número de trabajadores(as) estacionales reportados es mayor que el número de trabajadores(as) a tiempo determinado y subcontratados. Corrija este error.",
                    fr:
                      "Le nombre de travailleurs/euses saisonniers/ères rapporté est supérieur au nombre de travailleurs/euses à durée déterminée et en contrat de sous-traitance. Veuillez corriger l'erreur.",
                    pt:
                      "O número de trabalhadores(as) sazonais relatado é maior do que o número de trabalhadores(as) por período determinado e subcontratados. Por favor, corrija o erro."
                  },
                  expression:
              ...
              validators: [
                ...
                },
                {
                  ...
                  text: {
                    ...
                    es:
                      "El número de trabajadoras estacionales reportadas es mayor que el número de trabajadoras a tiempo determinado y subcontratadas. Corrija este error.",
                    fr:
                      "Le nombre de travailleuses saisonnières rapporté est supérieur au nombre de travailleuses à durée déterminée et en contrat de sous-traitance. Veuillez corriger l'erreur.",
                    pt:
                      "O número de trabalhadoras sazonais (mulheres) relatado é maior do que o número de trabalhadoras por período determinado e subcontratadas. Por favor, corrija o erro."
                  },
                  expression:
              ...
              validators: [
                ...
                },
                {
                  ...
                  text: {
                    ...
                    es:
                      "El número de trabajadores estacionales hombres reportados es mayor que el número de trabajadores a tiempo determinado y subcontratados. Corrija este error.",
                    fr:
                      "Le nombre de travailleurs saisonnier rapporté est supérieur au nombre de travailleurs à durée déterminée et en contrat de sous-traitance. Veuillez corriger l'erreur.",
                    pt:
                      "O número de trabalhadores sazonais (homens) relatado é maior do que o número de trabalhadores masculinos por período determinado e subcontratados. Por favor, corrija o erro."
                  },
                  expression:
              ...
              choices: [
                {
                  ...
                  text: {
                    ...
                    es:
                      "Ponga una marca aquí si no conoce el número de trabajadores(as) estacionales por género",
                    fr:
                      "Veuillez vérifier ici si vous ne connaissez pas le nombre de travailleurs/euses saisonniers/ères (par sexe)",
                    pt:
                      "Marque aqui se você não sabe o número de trabalhadores(as) sazonais por gênero"
                  }
                }
              ]
            }
          ...
          title: {
            ...
            fr:
              "Travailleurs/euses saisonniers/ères employés/ées par votre organisation",
      ...
      elements: [
          ...
          elements: [
            {
              ...
              html: {
                ...
                fr:
                  "<br>L'une des informations les plus importantes qui intéressent les parties prenantes et les consommateurs du commerce équitable est le nombre d'agriculteurs/rices et de travailleurs/euses faisant partie de la communauté mondiale Fairtrade et bénéficiant de la certification Fairtrade. Nous essayons également de mieux comprendre l'engagement des jeunes dans les organisations Fairtrade.",
                pt:
                  "<br>Uma das informações mais importantes nas quais as partes interessadas e os consumidores do Fairtrade querem saber quantos homens e mulheres fazendeiros(as) e trabalhadores(as) fazem parte da comunidade global do Fairtrade e se beneficiam da certificação do Fairtrade. Também estamos tentando entender melhor a participação dos(as) jovens nas organizações Fairtrade."
              }
            },
            {
              type: "html",
              ...
              html: {
                ...
                es:
                  "<br><b>Instrucciones:</b><hr>en esta sección, ingrese el número de trabajadores(as) en su organización, de acuerdo con los grupos etarios siguientes:<ul><li>16 a 28 años</li><li>29 a 35 años</li><li>36 años y más</li></ul>Si usted conoce el número de miembros para algunos grupos etarios, pero no todos, llene los campos que conoce y deje en blanco el resto. Si usted no conoce esta información para cualquiera o ninguno de los grupos etarios, ponga una marca en el cuadro siguiente y continúe a la página siguiente.<br><br><i>Si no se conocen número exactos, está bien si da cálculos o montos mínimos siempre y cuando los números que ingrese aquí no sean mayores que el número de trabajadores(as) ingresados en la página previa. También ingrese el número de mujeres y hombres en cada grupo etario si esta información es conocida y puede calcularse de manera razonable.</i>",
                fr:
                  "<br><b>Instructions :</b><hr>Dans cette section, veuillez indiquer le nombre de travailleurs/euses employés/ées de votre organisation, selon les groupes d'âge suivants :<ul><li>de 16 à 28 ans</li><li>de 29  à 35</li><li> de 36 ans et plus</li></ul>Si vous connaissez le nombre de travailleurs/euses pour certains groupes d'âge mais pas tous, veuillez remplir les champs que vous connaissez et laisser le reste vide. Si vous ne connaissez pas cette information pour l'un ou  tous les  groupes d'âge, veuillez cocher la case ci-dessous et passer à la page suivante.<br><br><i>Si les chiffres exacts ne sont pas connus, les estimations ou les montants minimaux sont acceptables, à condition que les chiffres rapportés ici ne soient pas supérieurs au nombre de travailleurs/euses rapporté à la page précédente. Veuillez également indiquer le nombre de femmes et d'hommes dans chaque groupe d'âge, si cette information est connue ou peut être estimée de façon raisonnable.</i>",
                pt:
                  "<br><b>Instruções:</b><hr>Nesta seção, favor informar o número de trabalhadores(as) empregados por sua organização, de acordo com as seguintes faixas etárias::<ul><li>16 a 28 anos de idade</li><li>29 a 35 anos de idade</li><li>36 anos ou mais</li></ul>Se você sabe o número de membros para algumas das faixas etárias, mas não todos, preencha os campos que você conhece e deixe o resto em branco. Se você não souber destas informações sobre qualquer um e todos os grupos etários, marque a caixa abaixo e prossiga para a página seguinte.<br><br><i>Se os números exatos não forem conhecidos, não há problema em fornecer cálculos ou valores mínimos, desde que os números inseridos aqui não sejam maiores que o número de trabalhadores(as) inseridos na página anterior. Insira também o número de mulheres e homens em cada faixa etária se essa informação for conhecida e puder ser razoavelmente estimada.</i>"
              }
            }
          ]
        },
        {
          ...
          title: {
            ...
            es:
              "¿Conoce usted el número de trabajadores(as) de su organización por grupo etario?",
            fr:
              "Connaissez-vous le nombre de travailleurs/euses embauchés par votre organisation par groupe d'âge ?",
            pt:
              "Você sabe o número de trabalhadores(as)  de sua organização por faixa etária?"
          },
          titleLocation: "hidden",
          hideNumber: true,
          choices: [
            {
              ...
              text: {
                ...
                es:
                  "Ponga una marca aquí si no conoce el número de trabajadores(as) empleados por su organización para cualesquiera de los grupos etarios especificados",
                fr:
                  "Veuillez vérifier ici si vous ne connaissez pas le nombre de travailleurs/euses employés/ées par votre organisation pour l'un des groupes d'âge spécifiés",
                pt:
                  "Por favor, marque aqui se você não souber o número de trabalhadores(as) empregados pela sua organização para qualquer uma das faixas etárias especificadas."
              }
            }
          ]
        },
          ...
          elements: [
            {
              ...
              elements: [
                  ...
                  validators: [
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de los trabajadores, tanto hombres como mujeres, es mayor que el total. Corrija este error.",
                        fr:
                          "La somme des travailleurs et des travailleuses est supérieure au total. Veuillez corriger l'erreur.",
                        pt:
                          "A soma de homens e mulheres trabalhadores é maior do que o total. Por favor, corrija o erro."
                      },
                      expression:
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de trabajadores(as) por grupo etario es mayor que el total reportado en la página previa. Corrija este error.",
                        fr:
                          "La somme des travailleurs par groupe d'âge est supérieure au total rapporté à la page précédente. Veuillez corriger l'erreur.",
                        pt:
                          "A soma dos trabalhadores(as) por faixa etária é maior do que o total relatado na página anterior. Por favor, corrija o erro."
                      },
                      expression:
                ...
                },
                {
                  ...
                  visibleIf:
                    "{total_workers_16_28} > {workers_female_16_28}+{workers_male_16_28} AND {workers_female_16_28} notempty AND {workers_male_16_28} notempty",
                  html: {
                    default:
                ...
                },
                {
                  ...
                  title: "workers_gender_not_known_16_28",
                  titleLocation: "hidden",
                  hideNumber: true,
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de trabajadores(as) de 16 a 28 años de edad por género",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre de travailleurs/euses de 16 à 28 ans (par sexe)",
                        pt:
                          "Marque aqui se você não sabe o número de trabalhadores(as) de 16 a 28 anos de idade por gênero"
                      }
                    }
                  ]
                }
            ...
            },
            {
              ...
              elements: [
                ...
                },
                {
                  ...
                  visibleIf:
                    "{total_workers_29_35} > {workers_female_29_35}+{workers_male_29_35} AND {workers_female_29_35} notempty AND {workers_male_29_35} notempty",
                  html: {
                    default:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Warning!</h3>\n<span style="font-size: medium;">The sum of male and female workers is less than the total. Please double check that the numbers reported are correct before moving on.</span>\n</div>',
                    es:
                ...
                },
                {
                  ...
                  title: "workers_gender_not_known_29_35",
                  titleLocation: "hidden",
                  hideNumber: true,
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de trabajadores(as) de 29 a 35 años de edad por género",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre de travailleurs/euses de 29 à 35 ans (par sexe)",
                        pt:
                          "Marque aqui se você não sabe o número de trabalhadores(as) de 29 a 35 anos de idade por gênero"
                      }
                    }
                  ]
                }
              ...
              elements: [
                {
                  ...
                  html: {
                    ...
                    pt:
                      "<br><b>Trabalhadores(as) de 36 anos de idade ou mais velhos</b>"
                  }
                },
                {
                  type: "text",
                ...
                },
                {
                  ...
                  visibleIf:
                    "{total_workers_36} > {workers_female_36}+{workers_male_36} AND {workers_female_36} notempty AND {workers_male_36} notempty",
                  html: {
                    default:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Warning!</h3>\n<span style="font-size: medium;">The sum of male and female workers is less than the total. Please double check that the numbers reported are correct before moving on.</span>\n</div>',
                    es:
                ...
                },
                {
                  ...
                  title: "workers_gender_not_known_36",
                  titleLocation: "hidden",
                  choices: [
                    {
                      value: "not_known",
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el número de trabajadores(as) de 36 años o más por género",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le nombre de travailleurs/euses de 36 ans et plus (par sexe)",
                        pt:
                          "Marque aqui se você não sabe o número de trabalhadores(as) de 36 anos de idade ou mais por gênero"
                      }
                    }
                  ]
                }
        ...
        },
        {
          ...
          elements: [
            {
              ...
              elements: [
                {
                  ...
                  title: {
                    ...
                    es:
                      "Número de trabajadores(as) reportados en un grupo etario:",
                    fr:
                      "Nombre de travailleurs/euses rapporté dans un groupe d'âge :",
                    pt:
                      "Número de trabalhadores(as) relatados em uma faixa etária:"
                  },
                  hideNumber: true,
                  expression:
              ...
              title: {
                default:
                  "Total number of workers employed by your organization: {workers_total}",
                es:
                  "Número total de trabajadores(as) empleados por su organización: {workers_total}",
                fr:
                  "Nombre total de travailleurs/euses employés/ées par votre organisation : {workers_total}",
                pt:
                  "Número total de trabalhadores(as) empregados por sua organização {workers_total}"
              }
            },
            {
              type: "panel",
              ...
              elements: [
                {
                  ...
                  title: {
                    default:
                      "Number of female workers reported in an age group:",
                    es: "Número de trabajadoras reportadas en un grupo etario:",
                    fr:
                      "Nombre de travailleuses rapportées dans un groupe d'âge :",
                    pt:
                      "Número total de trabalhadoras (mulheres) relatadas em uma faixa etária:"
                  },
                  hideNumber: true,
                  expression:
                ...
                },
                {
                  ...
                  title: {
                    ...
                    pt:
                      "Número de trabalhadoras (mulheres) (idade desconhecida):"
                  },
                  hideNumber: true,
                ...
                },
                {
                  ...
                  html: {
                    ...
                    pt:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Advertência!</h3> <span style="font-size: medium;">A soma de  trabalhadoras (mulheres) por faixa etária é maior que o total relatado nas páginas anteriores. Favor corrigir o erro antes de seguir em frente.</span> </div>'
                  }
                }
              ],
              title: {
                default:
                  "Total number of female workers employed by your organization: {workers_female}",
                es:
                  "Número total de trabajadoras empleadas por su organización: {workers_female}",
                fr:
                  "Nombre total de travailleuses employées par votre organisation : {Workers_women}",
                pt:
                  "Número total de trabalhadoras (mulheres) empregadas por sua organização {workers_female}"
              }
            },
            {
              type: "panel",
              ...
              elements: [
                {
                  ...
                  title: {
                    ...
                    es:
                      "Número de trabajadores hombre reportados en un grupo etario:",
                    fr:
                      "Nombre de travailleurs rapporté dans un groupe d'âge :",
                    pt:
                      "Número de trabalhadores (homens) relatados em uma faixa etária:"
                  },
                  hideNumber: true,
                  expression:
                ...
                },
                {
                  ...
                  title: {
                    ...
                    pt: "Número de trabalhadores (homens) (idade desconhecida):"
                  },
                  hideNumber: true,
                ...
                },
                {
                  ...
                  html: {
                    ...
                    pt:
                      '<br><div style="background-color: #ffd6d6; padding: 8px; border: 1px solid red; border-radius:8px"><h3 style="margin: auto; color: red; font-weight: bold">Advertência!</h3> <span style="font-size: medium;">A soma de trabalhadores (homens) por faixa etária é maior que o total relatado nas páginas anteriores. Favor corrigir o erro antes de seguir em frente.</span> </div>'
                  }
                }
              ],
              title: {
                default:
                  "Total number of male workers employed by your organization: {workers_male}",
                es:
                  "Número total de trabajadores hombres empleados por su organización: {workers_male}",
                fr:
                  "Nombre total de travailleurs employés par votre organisation : {workers_male}",
                pt:
                  "Número total de trabalhadores (homens) empregados por sua organização {workers_male}"
              }
            }
          ],
          visibleIf: "{workers_age_not_known} empty",
          title: {
            ...
            es:
              "Número resumido de trabajadores(as) reportados por grupo etario",
            fr: "Nombre total de travailleurs/euses rapporté par groupe d'âge",
            pt:
              "Número resumido de trabalhadores(as) relatados por faixa etária"
          }
        }
      ],
      visibleIf:
          ...
          elements: [
            {
              ...
              html: {
                ...
                es:
                  "<br>Otra área clave de información que interesa a diferentes actores de Fairtrade y los consumidores es la producción de productos certificados de Fairtrade. Esto ayuda a que Fairtade comprenda nuestras organizaciones de productores(as), analice el crecimiento, los rendimientos y el potencial de mercado con el paso del tiempo y guíe nuestra estrategia gobal.",
                fr:
                  "<br>La production de produits certifiés Fairtrade constitue une autre information clé qui intéresse les parties prenantes et les consommateurs de Fairtrade. Cela aide Fairtrade à comprendre nos organisations de producteurs ; à analyser la croissance, les rendements et le potentiel de marché dans le temps ; et à guider notre stratégie globale.",
                pt:
                  "<br>Outra área chave de informação de interesse para diferentes atores Fairtrade e consumidores é a produção de produtos certificados Fairtrade. Isso ajuda a Fairtrade a entender nossas organizações de produtores(as), analise crescimento, rendimentos e potencial de mercado ao longo do tempo e orientar nossa estratégia global."
              }
            },
            {
              type: "html",
              ...
              html: {
                ...
                es:
                  "<br><b>Instrucciones:</b><hr>ingrese el el área de tierra que gestiona su organización en esta sección.",
                fr:
                  "<br><b>Instructions :</b><hr>Dans cette section, veuillez indiquer la superficie des terres gérées par votre organisation.",
                pt:
                  "<br><b>Instruções:</b><hr>Nesta seção, favor inserir a área de terreno administrada por sua organização."
              }
            },
            {
              type: "html",
              ...
              html: {
                ...
                es:
                  "<br><i>El <b>área total de tierra gestionada</b> significa toda el área de tierra que gestionan los miembros de su organización y bajo el cultivo agrícola, ya sea certificado o no por Fairtrade.</i>",
                fr:
                  "<br><i>La <b> superficie totale des terres géréess</b> fait référence à toutes les terres gérées par les membres de votre organisation et cultivées, qu'elles soient certifiées Fairtrade ou non.</i>",
                pt:
                  "<br><i>A <b>área total de terra administrada</b> refere-se a toda a área de terra administrada por membros de sua organização e sob cultivo agrícola, certificada ou não pelo Fairtrade.</i>"
              }
            },
            {
              type: "html",
              ...
              html: {
                ...
                es:
                  "<br><i>El <b>área de tierra certificada por Fairtrade</b> hace referencia a solamente el área de tierra dentro de su organización que se encuentra bajo cultivos certificados por Fairtrade.</i>",
                fr:
                  "<br><i>La <b>superficie des terres certifiées Fairtrade</b> fait référence uniquement à la superficie des terres cultivées au sein de votre organisation sous certification Fairtrade</i>",
                pt:
                  "<br><i>A <b>área de terra certificada pelo Fairtrade</b> refere-se apenas à área de terra dentro de sua organização que está sob cultivo de culturas certificadas pelo Fairtrade.</i>"
              }
            }
          ]
        },
          ...
          elements: [
            {
              ...
              title: {
                ...
                es:
                  "¿En qué unidad desearía hacer su reporte de su área de tierra?",
                fr:
                  "Dans quelle unité souhaitez-vous déclarer la superficie de vos terres ?",
                pt:
                  "Em que unidade você gostaria de reportar sua área de terreno?"
              },
              hideNumber: true,
              isRequired: true,
              choices: [
              ...
              validators: [
                ...
                },
                {
                  ...
                  text: {
                    ...
                    es:
                      "No se permiten comas (,). Utilice el punto (.) como separador decimal.",
                    fr:
                      "Veuillez ne pas mettre de virgule (,). Utilisez un point (.) comme séparateur décimal.",
                    pt:
                      "Vírgulas (,) não são permitidas. Use o ponto (.) como separador decimal."
                  },
                ...
                },
                {
                  ...
                  text: {
                    ...
                    es:
                      "El área de tierra de Fairtrade es mayor que el área de tierra total.",
                    fr:
                      "La superficie des terres Fairtrade est supérieure à la superficie totale des terres.",
                    pt:
                      "A área do terreno Fairtrade é maior do que a área total do terreno."
                  },
                  expression:
            ...
            },
            {
              ...
              title: {
                ...
                es:
                  "Área de tierra certificada por Fairtrade (en {land_area_unit}):",
                fr:
                  "Superficie des terres certifiées Fairtrade (en {land_area_unit}):",
                pt:
                  "Área do terreno certificado Fairtrade (em {land_area_unit}):"
              },
              hideNumber: true,
              validators: [
                {
    ...
    },
    {
      ...
      elements: [
          ...
          elements: [
            ...
            },
            {
              ...
              html: {
                ...
                es:
                  "<br><b>Instrucciones:</b><hr>en esta sección, ingrese el área de tierra bajo cultivo y los volúmenes producidos por su organización en el ciclo de producción más reciente (2021-2022) para cada producto certificado por Fairtrade. Si su organización tiene también un pronóstico de volumen que será de calidad de exportación para venta en los términos de Fairtrade para el ciclo de producción próximo (2022-2023), ingrese también esta información.",
                fr:
            ...
            },
            {
              ...
              html: {
                ...
                es:
                  "<br>Note que <u>algunas unidades solo deben usarse para productos específicos</u>. Vea el cuadro informativo siguiente para obtener indicaciones sobre qué unidades usar para los productos de su organización.",
                fr:
                  "<br>Veuillez noter que <u>certaines unités doivent être utilisées uniquement pour des produits spécifiques</u>. Pour obtenir des conseils sur les unités à utiliser pour les produits de votre organisation, veuillez consulter la boîte d'information ci-dessous.",
                pt:
                  "<br>Observe que <u>algumas unidades só devem ser usadas para produtos específicos</u>. Para orientação sobre quais unidades usar para os produtos de sua organização, consulte a caixa de informações abaixo."
              }
            },
            {
              type: "html",
        ...
        },
        {
              ...
              elements: [
                {
                  ...
                  html: {
                    ...
                    es:
                      "<hr><b>Kilogramos (kg):</b> use kg cuando conozca el volumen de su producto en kilogramos.",
                    fr:
                      "<hr><b>Kilogrammes (kg):</b> Utilisez kg lorsque vous connaissez le volume de votre produit en kilogrammes.",
                    pt:
                      "<hr><b>Quilogramas (kg):</b> Utilize kg quando você souber o volume de seu produto em quilogramas."
                  }
                },
                {
                  type: "html",
                  ...
                  html: {
                    ...
                    es:
                      "<hr><b>Toneladas métricas (MT):</b> use MT cuando conozca el volumen de su producto en toneladas métricas.",
                    fr:
                      "<hr><b>Tonnes  métriques (t):</b> Utilisez t lorsque vous connaissez le volume de votre produit en tonnes métriques.",
                    pt:
                      "<hr><b>Toneladas métricas (TM):</b> Utilize TM quando você souber o volume de seu produto em toneladas métricas."
                  }
                },
                {
                  type: "html",
                  ...
                  html: {
                    ...
                    es:
                      "<hr><b>Cajas de 18.14 kg:</b> Solo para bananos/plátanos. Use cajas de 18.14 kg cuando conozca el número de cajas de bananos/plátanos.",
                    fr:
                      "<hr><b>Boîtes de 18.14 kg :</b> Uniquement pour les bananes. Utilisez des boîtes de 18.14 kg lorsque vous connaissez le nombre de boîtes de bananes.",
                    pt:
                      "<hr><b>Caixas de 18.14 kg: </b> Apenas para bananas/plátanos. Use caixas de 18.14 kg quando você souber o número de caixas de bananas/plátanos."
                  }
                },
                {
                  type: "html",
                  ...
                  html: {
                    ...
                    es:
                      "<hr><b>Cajas de 13.5 kg:</b> Solo para bananos/plátanos. Use cajas de 13.5 kg cuando conozca el número de cajas de bananos/plátanos.",
                    fr:
                      "<hr><b>Boîtes de 13.5 kg :</b> Uniquement pour les bananes. Utilisez des boîtes de 13.5 kg lorsque vous connaissez le nombre de boîtes de bananes.",
                    pt:
                      "<hr><b>Caixas de 13.5 kg:</b> Apenas para bananas/plátanos. Use caixas de 13.5 kg quando você souber o número de caixas de bananas/plátanos."
                  }
                },
                {
                  type: "html",
                  ...
                  html: {
                    ...
                    es:
                      "<hr><b>Libras:</b> use libras (lb) cuando conozca el volumen de su producto en libras.",
                    fr:
                      "<hr><b>Livres (Lb):</b> Utilisez lb lorsque vous connaissez le volume de votre produit en livres.",
                    pt:
                      "<hr><b>Libra:</b> Utilize libra quando você souber o volume do seu produto em libras."
                  }
                },
                {
                  type: "html",
                  ...
                  html: {
                    ...
                    es:
                      "<hr><b>Quintales (46 kg):</b> use quintales cuando conozca el volumen de su producto en quintales (1 quintal = 100 lb = 46 kg).",
                    fr:
                      "<hr><b>Quintaux (46 kg)(q):</b> Utilisez quintaux lorsque vous connaissez le volume de votre produit en quintaux.",
                    pt:
                      "<hr><b>Quintais (46 kg):</b> Utilize quintais quando você souber o volume de seu produto em quintais (1 quintal = 100 lbs = 46 kg)."
                  }
                },
                {
                  type: "html",
                  ...
                  html: {
                    ...
                    es:
                      "<hr><b>Tallos de flores:</b> solo para flores y plantas. Use cuando conozca el número de flores o plantas.",
                    fr:
                      "<hr><b>Tiges de fleurs:</b> Pour les fleurs et les plantes seulement. Utilisez cela lorsque vous connaissez le nombre de fleurs ou de plantes.",
                    pt:
                      "<hr><b>Caules de flores:</b> Apenas para flores e plantas. Use quando você souber o número de flores ou plantas."
                  }
                },
                {
                  type: "html",
                  ...
                  html: {
                    ...
                    es:
                      "<Hr><b>1000 tallos de flores:</b> solo para flores y plantas. Use cuando conozca el número de millares (1,000) de flores o plantas.",
                    fr:
                      "<Hr><b>11 000 tiges de fleurs:</b> Pour les fleurs et les plantes seulement. Utilisez cela lorsque vous connaissez le nombre de 1 000 lots de fleurs ou de plantes.",
                    pt:
                      "<hr><b>1000 caules de flores:</b> Apenas para flores e plantas. use quando você souber o número de 1.000 cachos de flores ou plantas."
                  }
                },
                {
                  type: "html",
                  ...
                  html: {
                    ...
                    es:
                      "<hr><b>Litros:</b> para aceite de argán y botellas de vino solamente. Use litros cuando conozca el volumen de su aceite o vino en litros.",
                    fr:
                      "<hr><b>Litres:</b>  Pour l'huile d'argan et les bouteilles de vin uniquement. Utilisez les litres lorsque vous connaissez le volume de votre huile ou de votre vin en litres.",
                    pt:
                      "<hr><b>Litros:</b> Apenas para garrafas de óleo de argão e vinho. usar litros quando você souber o volume de seu óleo ou vinho em litros."
                  }
                },
                {
                  type: "html",
                  ...
                  html: {
                    ...
                    es:
                      "<hr><b>Productos:</b> solo para cocos y balones deportivos. Use cuando conozca el número de cocos o balones deportivos producidos.",
                    fr:
                      "<hr><b>Pièces:</b> Uniquement pour les noix de coco et les ballons sportifs. Utilisez les pièces lorsque vous connaissez le nombre de noix de coco ou de balles de sport produites.",
                    pt:
                      "<hr><b>Itens:</b> Somente para cocos e bolas esportivas. Use itens quando você souber o número de cocos ou bolas esportivas produzidas."
                  }
                }
              ],
          ...
          title: {
            ...
            es:
              "Cuadro de información Unidades para reportar volúmenes producidos",
            fr:
              "Encadré informatif : Unités de déclaration des volumes produits",
            pt:
              "Caixa de informações Unidades para relatar os volumes produzidos"
          }
        },
        {
          type: "paneldynamic",
          ...
          templateElements: [
            {
              ...
              title: {
                ...
                es:
                  "Seleccione la categoría del producto de la lista desplegable que corresponda a su producto certificado por Fairtrade:",
                fr:
                  "Veuillez sélectionner la catégorie de produit dans la liste déroulante qui correspond à votre certification de produit Fairtrade :",
                pt:
                  "Favor selecionar a categoria de produto no menu suspenso que corresponde ao seu produto certificado Fairtrade:"
              },
              hideNumber: true,
              isRequired: true,
              choices: ["item1", "item2"]
            },
            {
              ...
              title: {
                ...
                es:
                  "Seleccione el tipo de {panel.major_product_category} de la lista desplegable que produjo su organización bajo la certificación Fairtrade",
                fr:
                  "Veuillez sélectionner le type de {panel.major_product_category} à partir du menu déroulant que votre organisation a produit sous la certification Fairtrade",
                pt:
                  "Favor selecionar o tipo de {panel.major_product_category} a partir da lista suspensa que sua organização produziu sob certificação Fairtrade"
              },
              hideNumber: true,
              isRequired: true,
              choices: ["item1", "item2"]
            },
            {
              ...
              title: {
                ...
                es:
                  "Si su producto no aparece en la lista y usted seleccionó “otro”, especifique aquí el producto para el cual su organización produjo bajo la certificación de Fairtrade:",
                fr:
                  "Si votre produit n'a pas été listé et que vous avez sélectionné « Autre », veuillez préciser ici le produit pour lequel votre organisation a produit sous la certification Fairtrade :",
                pt:
                  "Se seu produto não aparece na lista e você selecionou 'outro', favor especificar aqui o produto para o qual sua organização produziu sob a certificação Fairtrade:"
              },
              hideNumber: true
            },
            {
              ...
              elements: [
                {
                  ...
                  html: {
                    ...
                    es:
                      "<br><i>Para miel, ingrese el <b>número de panales/colmenas</b> en vez de {land_area_unit} de la tierra</i>",
                    fr:
                      "<br><i>Pour le miel, veuillez entrer le <b>nombre de ruches</b> au lieu des {land_area_unit} de terres</i>",
                    pt:
                      "<br><i>Para o mel, insira o <b>número de colmeias</b> em vez de {land_area_unit} de terra</i>"
                  }
                },
                {
                  type: "text",
                  ...
                  title: {
                    ...
                    es:
                      "¿Cuántos/as {land_area_unit} de tierra se cultivaron con {panel.minor_product_category}?",
                    fr:
                      "Combien de {land_area_unit} de terres on été cultivés/ées avec {panel.minor_product_category} ?",
                    pt:
                      "Qual o total de {land_area_unit} de terra foi cultivada com {panel.minor_product_category}?"
                  },
                  hideNumber: true,
                  validators: [
                    {
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "La suma de la superficie orgánica y convencional es mayor que el total. Corrija este error.",
                        fr:
                          "La somme des terres biologiques et conventionnelles est supérieure au total. Veuillez corriger l'erreur.",
                        pt:
                          "A soma da superfície orgânica e convencional é maior do que o total. Por favor, corrija o erro."
                      },
                      expression:
                  ...
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el área de tierra total para este producto",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas la superficie totale nombre de terres pour ce produit",
                        pt:
                          "Marque aqui se você não sabe a área total de terra para este produto"
                      }
                    }
                  ]
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "¿Cuántos/as {land_area_unit} de tierra estuvieron bajo cultivo convencional o en transición a orgánico?",
                    fr:
                      "Combien des {land_area_unit} de terres étaient dédiés/ées à la culture conventionnelle ou étaient en transition vers la culture biologique ?",
                    pt:
                      "Quantas {land_area_unit} de terra estavam sob cultivo convencional ou em transição para orgânico?"
                  },
                  hideNumber: true,
                  validators: [
                    {
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "El área de la superficie convencional es mayor que el área de tierra total. Corrija este error.",
                        fr:
                          "La superficie des terres conventionnelles est supérieure à la superficie totale des terres. Veuillez corriger l'erreur.",
                        pt:
                          "A área da superfície convencional é maior do que a área total da terra. Por favor, corrija o erro."
                      },
                      expression:
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "¿Cuántos/as {land_area_unit} de tierra estuvieron bajo cultivo de certificación orgánica?",
                    fr:
                      "Combien des {land_area_unit} de terres étaient dédiés/ées à la culture sous certification biologique ?",
                    pt:
                      "Quantas {land_area_unit} de terra estavam sob cultivo de certificação orgânica?"
                  },
                  hideNumber: true,
                  validators: [
                    {
                    ...
                    },
                    {
                      ...
                      text: {
                        ...
                        es:
                          "El área de la superficie orgánica es mayor que el área de tierra total. Corrija este error.",
                        fr:
                          "La superficie des terres biologiques est supérieure à la superficie totale des terres. Veuillez corriger l'erreur.",
                        pt:
                          "A área da superfície orgânica é maior do que a área total da terra. Por favor, corrija o erro."
                      },
                      expression:
                  ...
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce la extensión de {land_area_unit} del área de tierra orgánica y convencional para este producto",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas la superficie des terres en {land_area_unit} biologiques et conventionnelles pour ce produit",
                        pt:
                          "Marque aqui se você não conhece a {land_area_unit} orgânica e convencional para este produto"
                      }
                    }
                  ]
                }
              ...
              title: {
                ...
                es:
                  "Área de tierra bajo cultivo de Fairtrade: {panel.major_product_category} ({panel.minor_product_category})",
                fr:
                  "Superficie des terres cultivées sous certification Fairtrade : {panel.major_product_category} ({panel.minor_product_category})",
                pt:
                  "Área de terra sob cultivo Fairtrade: {panel.major_product_category} ({panel.minor_product_category})"
              }
            },
            {
              type: "panel",
              ...
              elements: [
                {
                  ...
                  title: {
                    ...
                    es:
                      "En qué forma de producto le gustaría reportar la producción de {panel.minor_product_category} de su organización?",
                    fr:
                      "Dans quel type de produit souhaitez-vous rapporter la production  {panel.minor_product_category} de votre organisation",
                    pt:
                      "Em que forma de produto você gostaria de relatar a produção de sua organização {panel.minor_product_category}?"
                  },
                  hideNumber: true,
                  isRequired: true
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "¿En qué unidad le gustaría reportar la producción de {panel.minor_product_category} de su organización?",
                    fr:
                      "Dans quelle unité souhaitez-vous rapporter la production  {panel.minor_product_category} de votre organisation",
                    pt:
                      "Em que unidade você gostaria de relatar a produção de sua organização {panel.minor_product_category}?"
                  },
                  hideNumber: true,
                  isRequired: true,
                  choices: [
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "Si su producto no se listó y usted seleccionó “otro”, especifique aquí la forma del producto para el cual reporta la producción:",
                    fr:
                      "Si votre produit n'a pas été listé et que vous avez sélectionné « Autre », veuillez préciser ici le type de produit pour lequel vous rapporter la production :",
                    pt:
                      "Se seu produto não aparece listado e você selecionou 'outro', favor especificar aqui a forma do produto para o qual você está relatando a produção:"
                  },
                  hideNumber: true
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "¿Cuántos/as {panel.volume_produced_unit} de {panel.product_form_name} produjo su organización bajo cultivo convencional o bajo transición a orgánico?",
                    fr:
                      "Combien des {panel.volume_produced_unit} de {panel.product_form_name} votre organisation a-t-elle produit dans le cadre de la culture conventionnelle ou en transition vers l'agriculture biologique ?",
                    pt:
                      "Quantos {panel.volume_produced_unit} de {panel.product_form_name} sua organização produziu sob cultivo convencional ou sob transição para orgânico?"
                  },
                  hideNumber: true,
                  validators: [
                    {
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "¿Cuántos/as {panel.volume_produced_unit} de {panel.product_form_name} produjo su organización bajo certificación orgánica?",
                    fr:
                      "Combien des {panel.volume_produced_unit} de {panel.product_form_name} votre organisation a-t-elle produit sous certification biologique ?",
                    pt:
                      "Quantos {panel.volume_produced_unit} de {panel.product_form_name} sua organização produziu sob certificação orgânica?"
                  },
                  hideNumber: true,
                  validators: [
                    {
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "¿El volumen producido reportado es la cantidad real o un aproximado?",
                    fr: "Le volume déclaré est-il le volume réel ou estimé ?",
                    pt:
                      "O volume produzido reportado é a quantidade real ou estimada?"
                  },
                  hideNumber: true,
                  defaultValue: "true",
                  labelTrue: {
                ...
                },
                {
                  ...
                  title: {
                    ...
                    fr:
                      "Quelle mesure avez-vous utilisée pour estimer le volume du produit ?",
                    pt:
                      "Que medida você utilizou para calcular o volume produzido?"
                  },
                  hideNumber: true,
                  choices: [
                    {
              ...
              title: {
                ...
                es:
                  "Volúmenes producidos en términos de Fairtrade en el ciclo de producción 2021-2022: {panel.major_product_category} ({panel.minor_product_category})",
                fr:
                  "Volumes produits conformément aux conditions Fairtrade dans le cycle de production 2021-2022 :  {panel.major_product_category} ({panel.minor_product_category})",
                pt:
                  "Volumes produzidos em termos Fairtrade no ciclo de produção de 2021-2022: {panel.major_product_category} ({panel.minor_product_category})"
              }
            },
            {
              type: "panel",
              ...
              elements: [
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "Rendimientos totales calculados de {panel.product_form_name} en {panel.volume_produced_unit}/{land_area_unit}",
                    fr:
                      "Estimation des rendements totaux de {panel.product_form_name} en {panel.volume_produced_unit}/{land_area_unit}",
                    pt:
                      "Rendimento total calculado de {panel.product_form_name} em {panel.volume_produced_unit}/{land_area_unit}"
                  },
                  hideNumber: true,
                  expression:
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "Rendimientos convencionales calculados de {panel.product_form_name} en {panel.volume_produced_unit}/{land_area_unit}",
                    fr:
                      "Estimation des rendements conventionnels de {panel.product_form_name} en {panel.volume_produced_unit}/{land_area_unit}",
                    pt:
                      "Rendimentos convencionais calculados de {panel.product_form_name} em {panel.volume_produced_unit}/{land_area_unit}"
                  },
                  hideNumber: true,
                  expression:
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "Rendimientos orgánicos calculados de {panel.product_form_name} en {panel.volume_produced_unit}/{land_area_unit}",
                    fr:
                      "Estimation des rendements biologiques de {panel.product_form_name} en {panel.volume_produced_unit}/{land_area_unit}",
                    pt:
                      "Rendimentos orgânicos calculado de {panel.product_form_name} em {panel.volume_produced_unit}/{land_area_unit}"
                  },
                  hideNumber: true,
                  expression:
              ...
              title: {
                ...
                es:
                  "Resumen de producción y rendimientos para el ciclo de producción 2021-2022: {panel.major_product_category} ({panel.minor_product_category})",
                fr:
                  "Résumé de la production et des rendements pour le cycle de production 2021-2022 : {panel.major_product_category} ({panel.minor_product_category})",
                pt:
                  "Resumo da produção e rendimentos para o ciclo de produção 2021-2022: {panel.major_product_category} ({panel.minor_product_category})"
              }
            },
            {
              type: "panel",
              ...
              elements: [
                {
                  ...
                  title: {
                    ...
                    es:
                      "¿En qué unidad le gustaría reportar el pronóstico de volumen de {panel.minor_product_category} de su organización?",
                    fr:
                      "Dans quelle unité souhaitez-vous rapporter le volume estimé  {panel.minor_product_category} de votre organisation ?",
                    pt:
                      "Em qual unidade você gostaria de relatar a previsão de volume de {panel.minor_product_category}?"
                  },
                  hideNumber: true,
                  isRequired: true,
                  choices: [
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "¿Cuántos/as {panel.volume_forecast_unit} de {panel.product_form_name} producidos bajo cultivo convencional o bajo la transición a orgánico pronostica su organización que tendrán calidad de exportación?",
                    fr:
                      "Combien des {panel.volume_forecast_unit} de {panel.product_form_name} produits/es sous culture conventionnelle ou en transition vers la culture biologique de qualité exportable votre organisation prévoit-elle d’avoir ?",
                    pt:
                      "Quantos {panel.volume_forecast_unit} de {panel.product_form_name} produzidos sob cultivo convencional ou em transição para orgânico sua organização prevê que serão de qualidade de exportação?"
                  },
                  hideNumber: true,
                  validators: [
                    {
                ...
                },
                {
                  ...
                  title: {
                    ...
                    es:
                      "¿Cuántos/as {panel.volume_forecast_unit} de {panel.product_form_name} producidos bajo certificación orgánica pronostica su organización que tendrán calidad de exportación?",
                    fr:
                      "Combien des {panel.volume_forecast_unit} de {panel.product_form_name} produits/es sous certification biologique de qualité exportable votre organisation prévoit-elle d’avoir ?",
                    pt:
                      "Quantos {panel.volume_forecast_unit} de {panel.product_form_name} produzidos sob certificação orgânica sua organização prevê que serão de qualidade para exportação?"
                  },
                  hideNumber: true,
                  validators: [
                    {
                  ...
                  choices: [
                    {
                      ...
                      text: {
                        ...
                        es:
                          "Ponga una marca aquí si no conoce el volumen pronosticado para este producto o si esta pregunta no aplica",
                        fr:
                          "Veuillez cocher ici si vous ne connaissez pas le volume estimé pour ce produit ou si cette question n'est pas applicable",
                        pt:
                          "Marque aqui se você não sabe o volume previsto para este produto ou se esta pergunta não é aplicável"
                      }
                    }
                  ]
                }
              ...
              title: {
                ...
                es:
                  "Pronóstico de producción y rendimientos para el ciclo de producción 2022-2023: {panel.major_product_category} ({panel.minor_product_category})",
                fr:
                  "Résumé des volumes et des rendements de qualité exportable pour le cycle de production 2022-2023 : {panel.major_product_category ({panel.minor_product_category})",
                pt:
                  "Previsão de produção e rendimentos para o ciclo de produção de 2022-2023: {panel.major_product_category} ({panel.minor_product_category})"
              }
            },
            {
              type: "text",
          ...
          noEntriesText: {
            ...
            es:
              "No ha ingresado ningún producto aún. Haga clic en el botón siguiente para comenzar.",
            fr:
              "Vous n'avez entré aucun produits.\nCliquez sur le bouton ci-dessous pour commencer.",
            pt:
              "Você ainda não inseriu nenhum produto. Clique no botão abaixo para começar."
          },
          confirmDelete: true,
          confirmDeleteText: {
      ...
      title: {
        ...
        fr:
          "Produits fabriqués par votre organisation conformément aux conditions de Fairtrade",
    ...
    },
    {
      ...
      elements: [
          ...
          elements: [
            {
              ...
              html: {
                default:
                  "<br><b>Thank you for filling out our survey</b>, it covered a set of questions related to some of Fairtrade's most frequently used data. Your contributions will help us better understand challenges in reporting and the quality of the data being reported.<br><br>In this section, we would appreciate to hear from you on the challenges, suggestions and feedback that you and your organization have relating to managing and sharing information to Fairtrade through FairInsight. We would appreciate any feedback you may be willing to share. We will use your feedback on this page only to identify common challenges faced by producer organizations and assess solutions for improvements.",
                es:
                  "<br><b>Gracias por participar en nuestra encuesta</b>. Esta cubrió un conjunto de preguntas relacionadas con algunos de los datos utilizados con más frecuencia en Fairtrade. Sus contribuciones nos ayudarán a comprender mejor los retos al hacer reportes y la calidad de los datos que se reportan.<br><br>En esta sección agradeceremos saber sobre sus comentarios acerca de los retos, sugerencias y retroalimentación que usted y su organización tengan con relación a gestionar y compartir información con Fairtrade mediante FairInsight. Apreciaremos cualquier retroalimetnación que desee compartir. Usaremos sus comentarios en esta página solo para identificar retos comunes que enfrenten las organizaciones de productores(as) y evaluar soluciones para mejoría.",
                fr:
                  "<br><b>Nous vous remercions d’avoir compléter notre enquête</b>, cette dernière couvre un ensemble de questions liées à un set de données des plus fréquemment utilisées par Fairtrade. Votres contributions nous aideront à mieux comprendre les défis liés à la déclaration des informations et à la qualité des données rapportées.<br><br>Dans cette section, nous aimerions connaître vos défis, suggestions et commentaires concernant la gestion et le partage des informations avec Fairtrade par le biais de FairInsight. Nous vous serions reconnaissants de nous faire part de vos commentaires. Nous utiliserons vos commentaires sur cette page uniquement pour identifier les défis communs auxquels sont confrontées les organisations de producteurs et pour créer des solutions en vue de les surmonter.",
                pt:
                  "<br><b>Obrigado por preencher nossa pesquisa</b>, ela cobriu um conjunto de perguntas relacionadas a alguns dos dados mais frequentemente utilizados em Fairtrade. Suas contribuições nos ajudarão a compreender melhor os desafios na elaboração de relatórios e a qualidade dos dados que estão sendo relatados.<br><br>Nesta seção, gostaríamos de ouvir de você sobre os desafios, sugestões e retroalimentação que você e sua organização tenham em relação ao gerenciamento e compartilhamento de informações com Fairtrade através da FairInsight. Agradecemos qualquer retroalimentação que você possa estar disposto a compartilhar. Utilizaremos seus comentários nesta página apenas para identificar os desafios comuns enfrentados pelas organizações de produtores(as) e avaliar soluções para melhorias."
              }
            }
          ]
        },
        {
          ...
          elements: [
            {
              ...
              title: {
                default:
                  "On a scale of 1 to 5, how easy overall was it to fill out the information in this survey?",
                es:
                  "En una escala del 1 al 5, ¿qué tan fácil fue en general llenar la información en esta encuesta?",
                fr:
                  "Sur une échelle de 1 à 5, dans l'ensemble, a-t-il été facile de remplir les informations de cette enquête ?",
                pt:
                  "Em uma escala de 1 a 5, que tão fácil foi, em geral, preencher as informações desta pesquisa?"
              },
              hideNumber: true,
              minRateDescription: {
            ...
            },
            {
              ...
              title: {
                default:
                  "On a scale of 1 to 5, how easy was it to understand the questions and what was being asked?",
                es:
                  "En una escala del 1 al 5, ¿qué tan fácil es comprender las preguntas y qué se estaba preguntando?",
                fr:
                  "Sur une échelle de 1 à 5, a-t-il été facile de comprendre les questions et ce qui était demandé ?",
                pt:
                  "Em uma escala de 1 a 5, que tão fácil foi entender as perguntas e o que estava sendo perguntado?"
              },
              hideNumber: true,
              minRateDescription: {
                default: "(Very Difficult)",
            ...
            },
            {
              ...
              title: {
                default:
                  "On a scale of 1 to 5, how relevant were the questions to your organization?",
                es:
                  "En una escala de 1 a 5, ¿qué tan relevante fueron las preguntas para su organización?",
                fr:
                  "Sur une échelle de 1 à 5, dans quelle mesure les questions étaient-elles pertinentes pour votre organisation ?",
                pt:
                  "Em uma escala de 1 a 5, que tão relevantes foram as perguntas para sua organização?"
              },
              hideNumber: true,
              minRateDescription: {
            ...
            },
            {
              ...
              title: {
                default:
                  "When completing this survey, did you have any issues or trouble with any parts of the survey? If so, please explain here (max. 500 characters):",
                es:
                  "Cuando completaba esta encuesta, ¿tuvo problemas con alguna parte de la misma? De ser así, explique aquí (máx. 500 caracteres):",
                fr:
                  "Au moment de remplir cette enquête, avez-vous eu des difficultés ou rencontré des problèmes avec certaines parties de l’enquête ? Si oui, veuillez expliquer ici (max. 500 caractères) :",
                pt:
                  "Ao concluir esta pesquisa, você teve algum problema ou dificuldade com alguma parte da pesquisa? Em caso positivo, explique aqui (máx. 500 caracteres):"
              },
              hideNumber: true,
              maxLength: 500
            },
            {
              ...
              title: {
                default:
                  "We want to improve how we ask this type of information from Fairtrade producer organizations. Do you have any suggestions for improving the survey in any way (on the questions, functionality, accessibility, etc.) that you would like to share? (max. 500 characters):",
                es:
                  "Deseamos mejorar cómo pedimos este tipo de información a las organizaciones productoras de Fairtrade. ¿Tiene usted sugerencias para mejorar la encuesta en cualquier manera (sobre preguntas, funcionalidad, accesibilidad, etc.) que desee compartir? (máx. 500 caracteres)",
                fr:
                  "Nous voulons améliorer la façon dont nous demandons ce type d'informations aux organisations de producteurs de Fairtrade. Avez-vous des suggestions pour améliorer l'enquête de quelque façon que ce soit (sur les questions, la fonctionnalité, l'accessibilité, etc.) que vous aimeriez partager ? (max. 500 caractères) :",
                pt:
                  "Queremos melhorar como pedimos este tipo de informação às organizações de produtores Fairtrade. Você tem alguma sugestão para melhorar a pesquisa de alguma forma (sobre as perguntas, funcionalidade, acessibilidade, etc.) que gostaria de compartilhar? (máx. 500 caracteres):"
              },
              hideNumber: true,
              maxLength: 500
            }
          ...
          title: {
            ...
            es: "Su experiencia sobre esta encuesta",
            fr: "Votre expérience relative à l’enquête",
            pt: "Sua experiência sobre esta pesquisa"
          }
        },
        {
          type: "panel",
          ...
          elements: [
            {
              ...
              title: {
                default:
                  "We want to better understand the challenges that producer organizations face when asked to share information with Fairtrade. Does your organization have any challenges that you would like to share with us? (max. 500 characters)",
                es:
                  "Deseamos comprender mejor los retos que enfrentan las organizaciones de productores(as) cuando se les pide compartir información con Fairtrade. ¿Su organización tiene retos que desearía compartir con nosotros? (máx. 500 caracteres)",
                fr:
                  "Nous voulons mieux comprendre les défis auxquels sont confrontées les organisations de producteurs lorsque nous leur demandons de partager des informations avec Fairtrade. Votre organisation a-t-elle des défis que vous aimeriez partager avec nous ? (max. 500 caractères)",
                pt:
                  "Queremos entender melhor os desafios que as organizações de produtores(as) enfrentam quando solicitadas a compartilhar informações com o Fairtrade. Sua organização tem algum desafio que você gostaria de compartilhar conosco? (máx. 500 caracteres)"
              },
              hideNumber: true,
              maxLength: 500
            }
          ...
          title: {
            ...
            pt: "Compartilhamento de informações com Fairtrade"
          }
        },
        {
          type: "panel",
          ...
          elements: [
            {
              ...
              title: {
                default:
                  "On a scale of 1 to 5, how easy do you find it to use FairInsight to manage your Fairtrade Premium Investments?",
                es:
                  "En una escala del 1 al 5, ¿qué tan fácil es para usted usar FairInsight para gestionar sus inversiones de Fairtrade Premium?",
                fr:
                  "Sur une échelle de 1 à 5, dans quelle mesure trouvez-vous facile d'utiliser FairInsight pour gérer vos investissements Fairtrade Premium ?",
                pt:
                  "Em uma escala de 1 a 5, que tão fácil você acha usar a FairInsight para administrar seus investimentos do Prêmio Fairtrade?"
              },
              hideNumber: true,
              minRateDescription: {
                default: "(Very Difficult)",
            ...
            },
            {
              ...
              title: {
                default:
                  "How can we improve your user experience to make managing your Fairtrade Premium Investments easier in FairInsight? (max. 500 characters)",
                es:
                  "¿Cómo podemos mejorar su experiencia del usuario para hacer que el manejo de inversiones de Fairtrade Premium sea más fácil en FairInsight? (máx. 500 caracteres)",
                fr:
                  "Comment pouvons-nous améliorer votre expérience utilisateur pour simplifier la gestion de vos investissements Fairtrade Premium dans FairInsight ? (max. 500 caractères)",
                pt:
                  "Como podemos melhorar sua experiência de usuário para facilitar o gerenciamento de seus investimentos Prêmio Fairtrade para que seja mais fácil na FairInsight? (máx. 500 caracteres)"
              },
              hideNumber: true,
              maxLength: 500
            },
            {
              ...
              title: {
                default:
                  "On a scale of 1 to 5, how useful do you see FairInsight being for your organization?",
                es:
                  "En una escala de 1 a 5, ¿qué tan útil ve usted a FairInsight para su organización?",
                fr:
                  "Sur une échelle de 1 à 5, dans quelle mesure FairInsight est utile pour votre organisation ?",
                pt:
                  "Em uma escala de 1 a 5, que tão útil você vê a FairInsight sendo para sua organização?"
              },
              hideNumber: true,
              minRateDescription: {
            ...
            },
            {
              ...
              title: {
                default:
                  "How can we make FairInsight more useful for your organization? (max. 500 characters)",
                es:
                  "¿Cómo podemos hacer que FairInsight sea más útil para su organización? (máx. 500 caracteres)",
                fr:
                  "Comment pouvons-nous rendre FairInsight plus utile pour votre organisation ? (max. 500 caractères)",
                pt:
                  "Como podemos tornar a FairInsight mais útil para sua organização? (máx. 500 caracteres)"
              },
              hideNumber: true,
              maxLength: 500
            },
            {
              ...
              title: {
                default:
                  "Do you have any other comments, suggestions or feedback you would like to share with us about FairInsight? (max. 500 characters)",
                es:
                  "¿Tiene otros comentarios, sugerencias o retroalimentación que desee compartir con nosotros acerca de FairInsight? (máx. 500 caracteres)",
                fr:
                  "Avez-vous d'autres commentaires, suggestions ou observations que vous aimeriez partager avec nous sur FairInsight ? (max. 500 caractères)",
                pt:
                  "Você tem algum outro comentário, sugestão ou retroalimentação que gostaria de compartilhar conosco sobre a FairInsight? (máx. 500 caracteres)"
              },
              hideNumber: true,
              maxLength: 500
            }
          ...
          elements: [
            {
              ...
              html: {
                default:
                  "<br><b>Thank you for your feedback!</b> We want to make reporting easier for you and your organization through FairInsight. We will review your inputs and keep them in mind for further improvements to the platform.",
                es:
                  "<br><b>¡Gracias por su retroalimentación!</b> Deseamos hacer que reportar sea más fácil para usted y su organización a través de FairInsight. Revisaremos sus comentarios y los tendremos presentes para mejorar más la plataforma.",
                fr:
                  "<br><b>Nous vous remercions pour vos commentaires !</b> Notre objectif est de simplifier la déclaration des informations pour vous et votre organisation grâce à FairInsight. Nous passerons en revue votres contributions et les garderons à l'esprit pour les améliorations futures de la plateforme.",
                pt:
                  "<br><b>Obrigado por sua retroalimentação</b> Queremos facilitar a elaboração de relatórios para você e sua organização através da FairInsight. Analisaremos seus comentários e os levaremos em consideração para melhorar ainda mais a plataforma."
              }
            }
          ]
        }
      ...
      title: {
        default:
          "Your Feedback on FairInsight & Reporting Information to Fairtrade",
        es:
          "Su retroalimentación sobre FairInsight y la información que se reporta a Fairtrade",
        fr:
          "Vos commentaires sur FairInsight et la déclaration d’informations à Fairtrade",
        pt:
          "Sua retroalimentação sobre FairInsight e informações relatadas a Fairtrade"
      },
      navigationTitle: {
        default: "Your Feedback",
        es: "Su retroalimentación",
        fr: "Vos commentaires",
        pt: "Seu  retroalimentação"
      }
    }
  ],
  showProgressBar: "top",
